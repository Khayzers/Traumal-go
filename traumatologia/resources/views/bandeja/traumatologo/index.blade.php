            ...
            <div class="content">
                ...
                <div class="stats-cards">
                    ...
                    <div class="stat-card stat-card-yellow">
                        ...
                        <div class="stat-progress">
                            <div class="stat-progress-bar" style="width: {{ ($pendientes / max($total, 1)) * 100 }}%">
                            </div>
                        </div>
                    </div>
                    <div class="stat-card stat-card-orange">
                        ...
                        <div class="stat-progress">
                            <div class="stat-progress-bar" style="width: {{ ($recibidas / max($total, 1)) * 100 }}%">
                            </div>
                        </div>
                    </div>
                    <div class="stat-card stat-card-green">
                        ...
                        <div class="stat-progress">
                            <div class="stat-progress-bar" style="width: {{ ($agendadas / max($total, 1)) * 100 }}%">
                            </div>
                        </div>
                    </div>
                    <div class="stat-card stat-card-red">
                        ...
                        <div class="stat-progress">
                            <div class="stat-progress-bar" style="width: {{ ($rechazadas / max($total, 1)) * 100 }}%">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="requests-table">
                        ...
                        <tbody>
                            @foreach ($solicitudes as $solicitud)
                                <tr>
                                    <td>
                                        <div class="id-cell">{{ $solicitud['id'] }}</div>
                                    </td>
                                    ...
                                    <td>{{ $solicitud['rut'] }}</td>
                                    <td><a href="tel:{{ $solicitud['telefono'] }}"
                                            class="phone-link">{{ $solicitud['telefono'] }}</a></td>
                                    <td>
                                        ...
                                        <div class="action-buttons">
                                            @if ($solicitud['estado'] == 'Recibida')
                                                ...
                                                <a href="#" class="action-button action-info"
                                                    title="Ver respuesta del centro" data-id="{{ $solicitud['id'] }}">
                ...
                <div class="pagination">
                    <span class="pagination-info">Mostrando 1-{{ count($solicitudes) }} de {{ $total }}
                        resultados</span>
            ...
            <div class="modal-body-resp">
                ...
                <div class="decision-options">
                    ...
                    <div class="decision-tabs">
                        <button type="button" class="tab-button active" data-tab="tab-agendar">Agendar
                            Paciente</button>
                            ...
                            <form id="formAgendar">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="fechaAgenda" name="fechaAgenda"
                                            class="form-control" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="horaAgenda">Hora de Agenda:</label>
                                        <input type="time" id="horaAgenda" name="horaAgenda" class="form-control"
                                            required>
                                    </div>
                                </div>
                        ...
                        <div class="option-rechazar">
                            ...
                            <form id="formRechazar">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="detalleRechazo" name="detalleRechazo" class="form-control" rows="3"
                                        placeholder="Explique con detalle el motivo del rechazo" required></textarea>
                                </div>
